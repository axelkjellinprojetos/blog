  ...
  <div class="row">
    <div class="container col-md-10 offset-md" >   
      <div class="card border">
        ...
        <div class="card-body" >
          <form action="listarcontatos"  method="POST"> 
            @csrf
            <div class="form-group" >
              <label for="nomeVendedor">Nome do Vendedor</label>
              <input type="text" class="form-control" id="nomeVendedor" name="nomeVendedor" placeholder="Escreva o nome do vendedor" >
            </div>
            <div class="form-group" >
              <label for="nomeDAEmpresa">Nome da Empresa</label>
              <input type="text" class="form-control" id="nomeDaEmpresa" name="nomeDaEmpresa" placeholder="Escreva o nome da empresa" >
            </div>
            <div class="form-group" >
              <label for="nomeDoContato">Nome do Contato</label>
              <input type="text" class="form-control" id="nomeDoContato" name="nomeDoContato" placeholder="Escreva o nome do contato" >
            </div>
            <div class="form-group" >
              <label for="numero">Numero de Telefone</label>
              <input type="tel" class="form-control" id="numero" name="numero" placeholder="47995024545" >
            </div>
            <div class="form-group" >
          ...
          <button type="submit" class="btn btn-primary btn-lg btn-block" >Salvar Cadastro</button>            
        </form>
      </div>
      @if($errors->any())
